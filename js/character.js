    ...
    if (dbQuick) {
      ...
      dbQuick.innerHTML = `
        ...
        <div style="display:flex; gap:10px; flex-wrap:wrap; margin-top:10px">
          <button class="btn secondary" type="button" id="dbEmbedBtn">Voir skills & dégâts</button>
        ...
        <div id="dbEmbedWrap" style="display:none; margin-top:12px">
          <div class="iframeShell" style="min-height:520px">
            ...
            <div class="iframeFallback" id="dbCharFallback">
              <div class="panel stack">
                ...
                <div class="small">Ton navigateur bloque l’affichage intégré. Utilise “Source DB”.</div>
                <a class="btn secondary" href="${escapeHtml(charUrl)}" target="_blank" rel="noopener">Source DB</a>
              </div>
            </div>
          </div>
        </div>
      ...
      btn?.addEventListener("click", () => {
        ...
        btn.textContent = open ? "Voir skills & dégâts" : "Masquer la DB";
