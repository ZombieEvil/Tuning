(() => {
  ...
  const init = async () => {
    ...
    const render = async () => {
      ...
      const faceUrl = urmId ? window.URM.assets.charaImageUrl(urmId) : null;
          ...
          <div class="speech">
            <div style="display:flex; align-items:center; justify-content:space-between; gap:12px; flex-wrap:wrap;">
              <div style="display:flex; align-items:center; gap:12px;">
                ${faceUrl ? `<img src="${faceUrl}" alt="${escapeHtml(base.name)}" style="width:52px; height:52px; object-fit:cover; border-radius:14px; border:3px solid var(--ink); box-shadow:var(--shadow);" loading="lazy">` : ``}
                <div>
              ...
              <div style="display:flex; gap:10px; flex-wrap:wrap;">
                ...
                <a class="btn ghost" href="${prefix}tuning/index.html">Voir la DB T.U.N.I.N.G</a>
              </div>
            </div>
